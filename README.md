...
- [CLAUDE.md](https://github.com/sanskrit-lexicon/MCI/blob/main/CLAUDE.md) — repository guide and data-format reference.
- [DATA_DICTIONARY.md](https://github.com/sanskrit-lexicon/MCI/blob/main/DATA_DICTIONARY.md) — markup tag reference.
- [CONTRIBUTING.md](https://github.com/sanskrit-lexicon/MCI/blob/main/CONTRIBUTING.md) · [CODE_OF_CONDUCT.md](https://github.com/sanskrit-lexicon/MCI/blob/main/CODE_OF_CONDUCT.md)
- [prefaces/README.md](https://github.com/sanskrit-lexicon/MCI/blob/main/prefaces/README.md) — front-matter OCR + EN/RU translations (see below).
...
- **Source language: English** (Sanskrit terms in IAST kept verbatim). Because the base text is English, there is **no `.en.md`**; only `.ru.md` translations are added. Consolidated editions: [`prefaces/mcipref_all.en.md`](https://github.com/sanskrit-lexicon/MCI/blob/main/prefaces/mcipref_all.en.md) (source) and [`prefaces/mcipref_all.ru.md`](https://github.com/sanskrit-lexicon/MCI/blob/main/prefaces/mcipref_all.ru.md) (Russian).
...
- See [CITATION.cff](https://github.com/sanskrit-lexicon/MCI/blob/main/CITATION.cff) for machine-readable citation.

> **Note:** the OCR'd front matter (see [`prefaces/`](https://github.com/sanskrit-lexicon/MCI/tree/main/prefaces)) and `csl-orig/v02/mci/mciheader.xml` attribute the work to **M. A. Mehendale (ed.), Bhandarkar Oriental Research Institute, Poona/Pune, 1993–2007**. The Pusalker / Bharatiya Vidya Bhavan attribution above should be reconciled against that primary evidence.
...
Corrections to the canonical source are never committed directly to `mci.txt`; they are expressed as change files and applied by scripts. The full 8-stage workflow, change-file format, and gotchas live in the canonical [csl-orig correction-workflow guide](https://github.com/sanskrit-lexicon/csl-corrections/blob/main/docs/correction-workflow.md).
