"""Synthetic tests for 08_markup_fix.py (MCI)."""
...
line, n = fix_trim_whitespace("<sup> word </sup>")
check("<sup> trim", line, "<sup>word</sup>")
check("<sup> trim n>=1", n>=1, True)
line, n = fix_trim_whitespace("<sup>clean</sup>")
check("<sup> no-op", line, "<sup>clean</sup>")
check("<sup> no-op n", n, 0)
